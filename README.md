...
<p>Проект 5: Анализ АБ теста для ритейлера</p> 
...
<p>Как решала: Основная часть решения осуществлялась в окружении Jupyter Notebook. Этапы решения: - Очистка сырых данных
- Агрегация и объединение таблиц
- Автоматизация статистических вычисления при помощи функций
- Расчет общих результатов АБ Теста
- Сегментация результатов АБ Теста по городам, по торговым точкам
- Создание отчета по АБ тесту, выгрузка полученных результатов в Excel
