...
## Проекты
### Проект "Анализ A/B теста для ритейлера"
<p>Цель А/B эксеримента: Исследование альтернативного метода воздействия на клиентские покупки с помощью пуш-уведомлений.<p>
<p>Таргет-метрики: конверсия из рекламы в покупку, средний чек.<p>
<p>Что нужно было сделать:<p>
<ol>
  <li>Проанализировать и визуализировать результаты, провести сегментацию, сделать выводы и сформулировать рекомендации для дальнейших запусков A/B Теста.</li>
  <li>Построить таблицу, которая будет в удобной форме хранить результаты A/B Теста </li>
</ol>
...
<br>
 ...
 <p>Выводы (итоги):<p>
<ol>
  <li>Изменение типа уведомления положительно сказалось и на среднем чеке, и на конверсии из рекламы в покупку. Наблюдается статистически значимое увеличение чека в тестовой группе по сравнению с контрольной на 135 р. и увеличение конверсии на 4 процентных пункта.
</li>
  <li>После проведенной сегментации было определено, что статистичеки значимое увеличение проявилось в основном в крупных городах (Москва, Санкт-Петербург). Также значимый рост был отмечен в Самаре. По остальным городам статистически значимых изменений не было.</li>
  <li>Сегментация по торговым точкам позволила провести разпределение для итогового отчета на положительные, отрицательные и нейтральные исходы.
  По нейтральным точкам, предположительно, результаты на торговых точках не видны, так как было создано слишком мало наблюдений. В связи с чем дополнительно создан калькулятор в Excel для определения минимального количества наблюдений для каждой из торговых точек на основе внешнего параметра MDE.</li>
</ol>
<br>
<br>

### Проект "Моделирование изменения балансов студентов для онлайн-школы"
<p>Что нужно было сделать:<p>
<ol>
...
### Проект "Калькулятор юнит-экономики онлайн-школы"
<p>Что нужно было сделать:<p>
<ol>
...
> <a href="https://github.com/Kostiuk-Daria/My-portfolio/blob/main/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%201/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%201.%20%D0%9A%D0%B0%D0%BB%D1%8C%D0%BA%D1%83%D0%BB%D1%8F%D1%82%D0%BE%D1%80%20%D1%8E%D0%BD%D0%B8%D1%82-%D1%8D%D0%BA%D0%BE%D0%BD%D0%BE%D0%BC%D0%B8%D0%BA%D0%B8%20%D0%BE%D0%BD%D0%BB%D0%B0%D0%B9%D0%BD-%D1%88%D0%BA%D0%BE%D0%BB%D1%8B.xlsx">Ссылка на проект</a>
<br> 
<p>Выводы (итоги):<p>
<ol>
...
### Проект "Построение витрины для модели машинного обучения в банке"
...
### Проект "Когортный анализ онлайн-кинотеатра с помощью SQL"
<p>Что нужно было сделать:<p>
<ol>
